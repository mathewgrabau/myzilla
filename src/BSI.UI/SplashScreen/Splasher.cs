...
namespace MyZilla.UI
{
    ...
    {
        private static Form m_SplashForm;
        private static ISplashForm m_SplashInterface;
        ...
        /// Show the SplashForm
        /// </summary>
        public static void Show(Type splashFormType, int top, int left)
        {
            ...
            m_SplashThread = new Thread(new ThreadStart(delegate()
            {
                ...
                if (m_SplashForm != null)
                {
                    ...
                    m_SplashForm.Top = top - m_SplashForm.Height / 2;
                    m_SplashForm.Left = left - m_SplashForm.Width / 2;
        ...
        public static void Close()
        {
            ...
            {
                MyLogger.Write(ex, "Splasher.Close", LoggingCategory.Exception); 
            }
